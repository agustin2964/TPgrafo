...
class Graph(List):
    ...
    class __nodeEdge:
        ...
        def __init__(self, value, weight, other_values = None):
            self.value = value
            self.weight = weight
    ...
    def insert_vertex(self, value, other_values = None):
        node_vertex = Graph.__nodeVertex(value)
        if other_values is not None:
            node_vertex.other_values = other_values
    ...
    def insert_edge(self, origin_vertex, destination_vertex, weight):
        ...
        if origin is not None and destination is not None:
            ...
            print(f'no se puede insertar arista {origin_vertex}, {destination_vertex}, falta uno de los vertices')

    def delete_edge(self, origin, destination, key_value = None):
    ...
    def delete_vertex(self, value, key_value_vertex = None, key_value_edges = 'value'):
    ...
    def amplitude_sweep(self, value):
        queue_vertex = Cola()
        self.mark_as_unvisited()
    ...
    def dijkstra(self, origin, destination=None):
        ...
        for vertex in self:
            ...
            no_visited.arrive([vertex.value, vertex, []], distance)
        while no_visited.size() > 0:
            ...
            for edge in edges:
                ...
                if pos is not None:
                    no_visited.elements[pos][1][2].append(value[1][0])
                    if costo_nodo_actual + edge.weight < no_visited.elements[pos][0]:
                        no_visited.elements[pos][1][2] = value[1][2] + [value[1][0]]
    ...
    def kruskal(self, origin_vertex, total_distance=False):
        ...
        return forest[from_vertex],c if from_vertex is not None else forest,
    ...
    def capitulos(self):
        aux=[]
        for v in self:
            if v.other_values["capitulos"]==[1,2,3,4,5,6,7,8,9]:
                aux.append(v.value)
        return aux